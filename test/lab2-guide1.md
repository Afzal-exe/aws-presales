...
4. Next, enter the following temporary access pass:
   
   * **Temporary Access Pass:** <inject key="AzureAdUserPassword"></inject> **(1)**
  
   ![Enter Your Password](../images/sc900-image-2.png)
 
6. If you get a pop-up stating **Action Required** click on **Ask Later**.
...
9. You're now logged in, and are all set to explore the powerful world of technology. Feel free to reach out if you have any questions along the way. Enjoy your workshop!
